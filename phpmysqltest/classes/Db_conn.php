...
class DatabaseConn {	
  ...
  public function dbOpen(){
    ...
    try {
      ...
      $dbHost = 'localhost';
      $dbName = 'calman';//this will be your WCC username
      $dbUsr = 'calman';//this will be your WCC username
      $dbPass = 'hWeV5Y6xvfDY';//this will be the password found in the video.
